...
| 11 | **Orbital History** | The Space-Track element archive in four views — **value**, **rate** of change, a **rate analysis** that reports whether the rate has itself changed (with manoeuvre-jump detection), and a **summary table** — with time-axis zoom and pan. |
